...
def train_dataset(
    ...
    output_train_vocab_path = outputs_path / f"output_train_vocab_{chosen_dataset}.pkl"
    with open(output_train_vocab_path, "wb") as f:
        pickle.dump(vocab, f)

    output_train_merges_path = outputs_path / f"output_train_merges_{chosen_dataset}.pkl"
...
if __name__ == "__main__":
    ...
    _ = parser.add_argument("dataset", type=str, choices=["tinystories", "openwebtext"])
    _ = parser.add_argument("split", type=str, choices=["train", "valid"])
